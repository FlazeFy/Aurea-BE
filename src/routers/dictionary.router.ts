...
import { getAllDictionaryController, hardDeleteDictionaryByIdController, postCreateDictionaryController } from "../controllers/dictionary.controller"
...
router.get("/", getAllDictionaryController)
